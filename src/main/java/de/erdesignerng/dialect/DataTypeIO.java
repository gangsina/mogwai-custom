...
public final class DataTypeIO {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DataTypeIO.class);
    ...
    public void loadUserTypes() throws TransformerException, IOException,
        ...
        logger.info("The datatype config directory is -->{}",theDataTypesDirectory.getAbsolutePath());
