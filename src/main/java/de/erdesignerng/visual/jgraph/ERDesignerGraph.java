...
public abstract class ERDesignerGraph extends JGraph {
    ...
    public boolean isDraggingCtrlView() {
        return draggingCtrlView;
    }

    public void setDraggingCtrlView(boolean draggingCtrlView) {
        this.draggingCtrlView = draggingCtrlView;
    }

    /**
     * 用来控制拖动整个界面移动. 代替点击滚动条.
     */
    private boolean draggingCtrlView;
