    ...
    public EditorPanel() {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                logger.info("addMouseListener click EditorPanel at ({},{})",e.getPoint().getX(),e.getPoint().getY());
        ...
        addMouseMotionListener(new MouseAdapter() {
            ...
            public void mouseMoved(MouseEvent e) {
                logger.info("addMouseMotionListener click EditorPanel at ({},{})",e.getPoint().getX(),e.getPoint().getY());
                EditorComponent theSelected = findEditorComponentAt(e.getPoint());
                if (theSelected != null) {
